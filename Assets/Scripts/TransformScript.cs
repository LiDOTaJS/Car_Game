      ...
      if (objectScript.lastDragged != null)
        {
            ...
            if (Input.GetKey(KeyCode.UpArrow))
            {
                if(objectScript.lastDragged.GetComponent<RectTransform>().transform.localScale.y < 1.5f)
                {
                    objectScript.lastDragged.GetComponent<RectTransform>().transform.localScale = 
                        new Vector2(objectScript.lastDragged.GetComponent<RectTransform>().transform.localScale.x, 
            ...
            if (Input.GetKey(KeyCode.LeftArrow))
            {
                ...
                {
                    objectScript.lastDragged.GetComponent<RectTransform>().transform.localScale =
                        new Vector2(objectScript.lastDragged.GetComponent<RectTransform>().transform.localScale.x - 0.001f,
