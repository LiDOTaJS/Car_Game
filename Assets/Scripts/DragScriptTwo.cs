...
public class DragScriptTwo : MonoBehaviour, IPointerDownHandler, IBeginDragHandler, IDragHandler, IEndDragHandler
{
    ...
    public void OnPointerDown(PointerEventData eventData)
    {
        if (Input.GetMouseButton(0) && Input.GetMouseButton(2) == false)
        {
            ...
            objectScript.audioSource.PlayOneShot(objectScript.audioClips[0], 1f);
        }
    }
    ...
    public void OnEndDrag(PointerEventData eventData)
    {
        ...
        {
            Debug.Log("Draggin Ended: " + gameObject.name);
